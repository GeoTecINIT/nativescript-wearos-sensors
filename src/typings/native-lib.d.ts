		...
		export namespace geotec {
			export namespace wearos_sensors {
				export namespace command {
					export class WearosCommandService {
						public static class: java.lang.Class<es.uji.geotec.wearos_sensors.command.WearosCommandService>;
						public constructor();
						public static setCommandServiceDelegate(param0: es.uji.geotec.wearos_sensors.messaging.WearableListenerServiceDelegate): void;
